      ...
      registerDecorator({
        ...
        validator: {
          validate(
            ...
            const asPromise = validationOptions && validationOptions.context &&
  ...
  it("if firstName is empty and lastLame is not empty then it should fail", () => {
    ...
    return validator.validate(model).then((errors) => {
      ...
      expect(errors[0].constraints).toEqual({
        isLongerThan: "firstName must be longer then lastName. Given value: ",
      });
    });
  });
      ...
      registerDecorator({
        ...
        validator: {
          ...
          defaultMessage(args: ValidationArguments): string {
            return args.property + " must be longer then " +
              args.constraints[0];
          },
        },
      });
